...
exceptions = ['ji-Hebr-UA', 'kxc-Ethi', 'bji-Ethi', 'drh-Mong-CN', 'dyl-Zxxx-TR', 'en-Latn-CQ', 'gon-Deva-IN', 'lfb-Latn-CM', 'mww-Hmnp-US', 'olb-Latn-CM', 'osd-Cyrl-RU', 'pi-Latn-GB', 'udi-Aghb-RU', 'oak-Beng-BD', 'oak-Latn-IN', 'zag-Berf-SD']
